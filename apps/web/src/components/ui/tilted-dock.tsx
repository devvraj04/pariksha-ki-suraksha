...
const icons = [
  { id: 1, icon: <Home size={28} />, label: "Home", href: "/" },
  { id: 2, icon: <Search size={28} />, label: "Portal", href: "/student/dashboard" },
  { id: 3, icon: <Bell size={28} />, label: "Grievances", href: "/student/grievances" },
  { id: 4, icon: <User size={28} />, label: "Profile", href: "/student/dashboard" },
  { id: 5, icon: <Settings size={28} />, label: "Admin", href: "http://admin.localhost:3000/login" },
];
